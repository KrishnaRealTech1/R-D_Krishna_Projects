# RealTech iTOLL Automation — Standalone EXE
...
```text
Publish\StandaloneWinX64\RealTechiTOLLAutomation.exe
```
...
5. Copy `Publish\StandaloneWinX64\RealTechiTOLLAutomation.exe` to the target computer.
