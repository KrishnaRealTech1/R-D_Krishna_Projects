<p align="center">
  <img src="src/RfidVehicleAccess.App/Assets/RealTechStpAutomationLogo.png" alt="RealTech STP Automation logo" width="220" />
</p>

# RealTech STP Automation
...
- Placeholder server worker until MQTT payloads/topics and FTP/SFTP details are supplied.
...
3. Distribute `Publish\StandaloneWinX64\RealTechSTPAutomation.exe`.
...
- `Server`: MQTT and FTP/SFTP placeholders.
...
```json
"Cameras": {
  "ImageFilePrefix": "Tambaram STP Site 1",
...
```text
Tambaram STP Site 1 - 2026-07-16_16-44-57-123 - IN - <transaction-id>.png
```
