...
{
    private const string AppUserModelId = "RealTech.iTOLL.Automation";
    private const string IconResourceUri =
        "pack://application:,,,/Assets/RealTechiTollAutomation.ico";
    ...
    private static void ApplyNativeIcon(Window window)
    {
        ...
        {
            // Branding must never interrupt the access-control workflow.
        }
    }
