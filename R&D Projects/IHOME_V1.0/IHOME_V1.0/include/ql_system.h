...
#define     MSG_ID_MSG   (MSG_ID_USER_START + 3)
#define     MSG_ID_SEND   (MSG_ID_USER_START + 4)
#define     MSG_ID_gprs_init   (MSG_ID_USER_START + 5)
#define     MSG_ID_FOTA   (MSG_ID_USER_START + 6)
