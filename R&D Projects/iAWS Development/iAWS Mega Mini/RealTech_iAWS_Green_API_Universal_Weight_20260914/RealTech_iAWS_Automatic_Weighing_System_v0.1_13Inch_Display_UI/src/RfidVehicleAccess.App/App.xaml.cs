...
public partial class App : Application
{
    ...
    private static void ApplyPaymentCompatibilityDefaults(AppOptions options)
    {
        ...
        var selected = options.Payment.Categories.FirstOrDefault(category =>
            string.Equals(category.Name, options.Payment.DefaultCategory, StringComparison.OrdinalIgnoreCase))
            ?? options.Payment.Categories[0];
        options.Payment.DefaultCategory = selected.Name;
        options.Processing.EntryFee = selected.Price;
    }
