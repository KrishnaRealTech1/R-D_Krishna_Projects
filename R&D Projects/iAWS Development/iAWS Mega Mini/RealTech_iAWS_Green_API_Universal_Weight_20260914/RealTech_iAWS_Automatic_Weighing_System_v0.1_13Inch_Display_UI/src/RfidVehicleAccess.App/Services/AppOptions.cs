...
public sealed class PaymentOptions
{
    ...
    [
        new VehiclePaymentCategoryOptions { Name = "Default", Price = 0m }
    ];
}
...
{
    // Retained for iTOLL-compatible payment configuration UI. iAWS weighing logic does not depend on this value.
...
public sealed class WeighbridgeOptions
{
    ...
    public bool UniversalFormatEnabled { get; set; } = true;
...
public sealed class ServerOptions
{
    ...
    public HttpApiOptions Api { get; set; } = new();
...
public sealed class MqttOptions
{
    ...
    // iTOLL-compatible advanced MQTT fields. They remain optional in iAWS.
...
public sealed class HttpApiOptions
{
    ...
    public string Endpoint { get; set; } = "http://dev.igps.io/aws_raw_data/iAWS_universalAPi.php";
    public string Method { get; set; } = "POST";
    public int RequestTimeoutSeconds { get; set; } = 30;
    public string Action { get; set; } = "WEIGH";
    public string DefaultMaterialType { get; set; } = "Municipal Solid Waste";
}
