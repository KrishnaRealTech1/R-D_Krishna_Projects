...
public static class PathResolver
{
    ...
    // iAWS uses its own application-data root so it never shares iTOLL
    // database, images, logs or configuration files.
    ...
    {
        EnsureCaptureStorage();
        var folder = Path.Combine(RealtechSystemsRoot, "Logs");
    ...
    {
        EnsureCaptureStorage();
        var folder = Path.Combine(RealtechSystemsRoot, "Images");
        Directory.CreateDirectory(folder);
        return folder;
    }
    ...
    {
        EnsureCaptureStorage();
        var folder = Path.Combine(RealtechSystemsRoot, "Audio");
        Directory.CreateDirectory(folder);
        return folder;
    }
    ...
    public static string EnsureCaptureStorage()
    {
        ...
        var audioFolder = Path.Combine(root, "Audio");
