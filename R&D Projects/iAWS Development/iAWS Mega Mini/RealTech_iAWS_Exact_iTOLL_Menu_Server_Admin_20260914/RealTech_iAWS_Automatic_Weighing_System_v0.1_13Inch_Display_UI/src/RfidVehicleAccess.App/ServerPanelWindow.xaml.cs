...
public partial class ServerPanelWindow : Window
{
    ...
    private TabItem CreateDeviceAndProcessingTab()
    {
        ...
        var weighbridge = CreateGroup("iAWS Weighbridge Processing", grid =>
        {
            ...
            AddTextField(grid, "Weighbridge.DataPrefix", "Weight Data Prefix", "Example: wn for input wn009011 kg.");
            AddTextField(grid, "Weighbridge.UnitText", "Weight Unit", "Example: kg.");
        });
    ...
    private AppOptions BuildOptionsFromFields()
    {
        ...
        updated.Weighbridge.DataPrefix = ReadRequiredText("Weighbridge.DataPrefix", "Weight Data Prefix");
        updated.Weighbridge.UnitText = ReadRequiredText("Weighbridge.UnitText", "Weight Unit");
