...
public partial class App : Application
{
    ...
    protected override async void OnStartup(StartupEventArgs e)
    {
        ...
        try
        {
            ...
            await ReportStartupProgressAsync(
                ...
                "Creating RFID, camera, hardware, MQTT, SFTP and user-interface services.",
                40);
            ...
            _host = Host.CreateDefaultBuilder()
                .ConfigureServices(services =>
                {
                    ...
                    services.AddSingleton<SftpImageUploadService>();
            ...
            await ReportStartupProgressAsync(
                loadingWindow,
                "Opening RealTech STP Automation",
        ...
        catch (Exception ex)
        {
            ...
            MessageBox.Show(
                ex.ToString(),
                "RealTech STP Automation - Startup Error",
                MessageBoxButton.OK,
    ...
    private static void ApplyMqttTopicCompatibilityDefaults(AppOptions options)
    {
                ...
                StringComparison.OrdinalIgnoreCase))
        {
            ...
            options.Device.DeviceName = "Tambaram STP 001";
        }
