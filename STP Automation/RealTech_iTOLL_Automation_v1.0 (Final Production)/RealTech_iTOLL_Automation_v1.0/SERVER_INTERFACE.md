# RealTech iTOLL Automation - Server Interface Specification

**Application version:** 0.1.51  
**Protocol:** MQTT 3.1.1 for JSON messages; SFTP or FTP for captured images  
...
6. In the background, the image is uploaded by the configured SFTP or FTP mode when available.
...
```json
{
  ...
  "imageFileName": "Tambaram iTOLL Site 1 - 2026-07-22_10-30-15-125 - IN - 8d1d31e9-9a38-472c-a3a0-df88f5bc52e7.png",
  "imageRemotePath": "/home/ftpuser/ftp/STP/Tambaram/STP-IWS-001/Tambaram iTOLL Site 1 - 2026-07-22_10-30-15-125 - IN - 8d1d31e9-9a38-472c-a3a0-df88f5bc52e7.png",
  "tripDate": "2026-07-22",
...
| `imageRemotePath` | string/null | no | Remote SFTP/FTP path after successful image upload. |
...
1. Start the RealTech iTOLL Automation application and confirm the server log reports that the recharge
...
- Store broker and image-upload credentials with restricted file permissions. Prefer SFTP when encryption in transit is required; standard FTP is unencrypted.
