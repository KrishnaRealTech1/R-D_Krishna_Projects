...
# 2 "<built-in>" 2
# 1 "Feedback_Driver_Board_V2.c" 2
...
# 12 "Feedback_Driver_Board_V2.c" 2
# 78 "Feedback_Driver_Board_V2.c"
...
static void Initialize_Device(void)
{
# 111 "Feedback_Driver_Board_V2.c"
    ...
    GPIO = 0x00;
# 146 "Feedback_Driver_Board_V2.c"
    TRISIO = 0b00111110;
...
# 168 "Feedback_Driver_Board_V2.c"
    ...
    do { GPIObits.GP0 = 0; } while (0);
}
# 215 "Feedback_Driver_Board_V2.c"
static void Delay_10ms(void)
{
    TMR0 = 217;
    INTCONbits.T0IF = 0;
...
# 247 "Feedback_Driver_Board_V2.c"
static void Delay_1Second(void)
{
...
# 289 "Feedback_Driver_Board_V2.c"
static unsigned char Pin5_Is_Stable_Low(void)
{
...
# 323 "Feedback_Driver_Board_V2.c"
static unsigned char Pin5_Is_Stable_High(void)
{
    unsigned char sampleCount;
...
# 416 "Feedback_Driver_Board_V2.c"
static unsigned char Pin5_Remains_High_For_Seconds(
    unsigned char seconds
)
{
...
# 488 "Feedback_Driver_Board_V2.c"
static void Pulse_Pin7(void)
{
    do { GPIObits.GP0 = 1; } while (0);

    Delay_Seconds(3U);

    do { GPIObits.GP0 = 0; } while (0);
}
# 506 "Feedback_Driver_Board_V2.c"
static void Run_Initial_Pin7_Sequence(void)
{
...
{
    Initialize_Device();
# 533 "Feedback_Driver_Board_V2.c"
    do { GPIObits.GP0 = 0; } while (0);
    Wait_For_Pin5_Low();
    ...
    while (1)
    {
        ...
        Wait_For_Pin5_High();
# 551 "Feedback_Driver_Board_V2.c"
        Run_Initial_Pin7_Sequence();
# 564 "Feedback_Driver_Board_V2.c"
