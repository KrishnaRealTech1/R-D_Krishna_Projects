...
void debounce_inputs_10ms(void)
{
    ...
    else if (brush_sw_integrator >= 2u)
    {
        brush_sw_integrator = 2u;
        g_brush_sw_state = 1;
    }

    if (raw_vac)
    {
        if (vac_sw_integrator < 2u)
        {
            vac_sw_integrator++;
        }
    }
    ...
    else if (vac_sw_integrator >= 2u)
    {
        vac_sw_integrator = 2u;
        g_vac_sw_state = 1;
    }
}
...
void handle_brush_switch_10ms(void)
{
    ...
    if (g_brush_tracking_press && g_brush_sw_state)
    {
            ...
            (g_brush_hold_ticks >= 100u))
        {
            ...
            g_brush_release_ticks_left = 50u;
