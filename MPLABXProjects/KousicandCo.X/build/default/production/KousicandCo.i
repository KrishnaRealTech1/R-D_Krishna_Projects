...
# 71 "KousicandCo.c"
static volatile uint8_t gpio_shadow = 0x04u;
...
static volatile _Bool uart_tx_busy = 0;
...
static void gpio_write_atomic(uint8_t mask, _Bool level)
{
    uint8_t gie_state;
...
static _Bool pin2_is_high(void)
{
    if ((GPIO & 0x20u) != 0u)
    {
        return 1;
...
{
    gpio_write_atomic(0x10u, 1);
}

static void led_off(void)
{
    gpio_write_atomic(0x10u, 0);
}
...
static _Bool uart_is_busy(void)
{
    return uart_tx_busy;
}
...
{
    uart_send_string_async("Detects");
