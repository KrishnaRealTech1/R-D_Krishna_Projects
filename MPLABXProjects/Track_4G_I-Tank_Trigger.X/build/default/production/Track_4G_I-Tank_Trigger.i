...
# 2 "<built-in>" 2
# 1 "Track_4G_I-Tank_Trigger.c" 2
# 12 "Track_4G_I-Tank_Trigger.c"
...
# 12 "Track_4G_I-Tank_Trigger.c" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\c90\\stdint.h" 1 3
# 13 "Track_4G_I-Tank_Trigger.c" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\c90\\stdbool.h" 1 3
# 14 "Track_4G_I-Tank_Trigger.c" 2
...
# 38 "Track_4G_I-Tank_Trigger.c"
static volatile uint8_t gpio_shadow = 0;


static __attribute__((inline)) void gpio_apply(void)
{
    GPIO = gpio_shadow;
}


static __attribute__((inline)) void output_set(_Bool on)
{
    if (on)
        gpio_shadow |= (uint8_t)(1u << 5);
    else
        gpio_shadow &= (uint8_t)~(1u << 5);
