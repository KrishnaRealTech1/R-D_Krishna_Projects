...
echo "=================================================="
echo " G-Cam Full Clean Reinstall - V6.6 FIXED"
...
cat > "$APP_DIR/data/config.json" <<JSON
{
  ...
  "software_version": "Version 6.6",
  "software_features": "AI Mode/Normal Mode Interface for Garbage Detection + Garbage Reference Upload from PC/Mobile interface",
...
SOFTWARE_VERSION = str(CONFIG.get("software_version", "Version 6.6")).strip()
SOFTWARE_FEATURES = str(
    CONFIG.get(
        "software_features",
                "AI Mode/Normal Mode Interface for Garbage Detection + Garbage Reference Upload from PC/Mobile interface"
    )
).strip()
