...
echo "=================================================="
echo " G-Cam Full Clean Reinstall - V7.0 MERGED / Pi 5 1GB"
echo " Version 7.0 DVR + Storage Playback + Permanent Cloudflare"
...
cat > "$APP_DIR/data/config.json" <<JSON
{
  ...
  "software_version": "Version 7.0-Edge-AI-Upgrade",
  "software_features": "Version 7.0 DVR/Playback/Cloudflare + Person/Vehicle + Garbage AI/Normal + MQTT Audio + Live Talk + White/Red UI",
...
app.secret_key = hashlib.sha256(
    f"gcam-dashboard-session:{DEVICE_ID}:v7".encode("utf-8")
).hexdigest()
app.config.update(
...
echo "[V7.0 FIX PATCH] Applying UI text visibility and garbage detect compatibility fixes..."
...
echo "[V7.0 FIX PATCH] Completed."


# V7.0 FINAL TEXT OVERRIDE
...
echo "[V7.0 GARBAGE MANUAL DETECT FIX] Applying runtime patch..."
...
echo "[V7.0 GARBAGE MANUAL DETECT FIX] Completed."


echo "[V7.0 VOLTAGE CURRENT HEALTH] Adding INA226 voltage/current dashboard support..."
...
echo "[V7.0 VOLTAGE CURRENT HEALTH] Completed."
