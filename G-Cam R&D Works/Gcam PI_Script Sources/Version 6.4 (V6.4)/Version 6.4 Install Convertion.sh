...
echo "=================================================="
echo " G-Cam Full Clean Reinstall - V6.4 FIXED"
...
cat > "$APP_DIR/data/config.json" <<JSON
{
  ...
  "software_version": "Version 6.4",
  "software_features": "Offline-Audio Mute + Multi-Point Geofence + Seperate URLs for Person/Garbage/Vehicle Geofencing + Live Audio Stream + Control Panel Interface in Dashboard + Static & Moving Vehicle Switching",
...
SOFTWARE_VERSION = str(CONFIG.get("software_version", "Version 6.4")).strip()
SOFTWARE_FEATURES = str(
    CONFIG.get(
        "software_features",
                "Offline-Audio Mute + Multi-Point Geofence + Seperate URLs for Person/Garbage/Vehicle Geofencing + Live Audio Stream + Control Panel Interface in Dashboard + Static & Moving Vehicle Switching"
    )
).strip()
